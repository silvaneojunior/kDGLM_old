...
No matter the parametrization, the link function $g$ will always be the logarithm function. 
...
The arguments `phi`, `mu`, `alpha`, `beta` and `sigma` should be character strings indicating the name of the linear predictor associated with
